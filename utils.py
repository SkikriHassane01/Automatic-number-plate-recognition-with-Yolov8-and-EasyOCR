...
def get_car(license_plate, vehicle_track_ids):
    ...
    for j in range(len(vehicle_track_ids)):
        x1car, y1car, x2car, y2car, car_id = vehicle_track_ids[j]
    ...
    with open(output_path, "w") as f:
        ...
        for frame_number in results.keys():
            ...
            for car_id in results[frame_number].keys():
                ...
                if (
                    "car" in results[frame_number][car_id].keys()
                    and "license_plate" in results[frame_number][car_id].keys()
                    and "text" in results[frame_number][car_id]["license_plate"].keys()
                ):
                    f.write(
                        "{},{},{},{},{},{},{}\n".format(
                            frame_number,
                            ...
                            "[{} {} {} {}]".format(
                                results[frame_number][car_id]["license_plate"]["bbox"][
                                    0
                                ],
                                results[frame_number][car_id]["license_plate"]["bbox"][
                                    1
                            ...
                            results[frame_number][car_id]["license_plate"][
                                "bbox_score"
                            ],
